				...
				<div class="col-md-3 menu">
					<ul class="list-group">
						<li class="list-group-item active p-0">
							<a href="" class="d-block" style="padding: 0.9rem">Tarefas pendentes</a>
						</li>
								...
								<?php foreach ($tarefas as $i => $tarefa) { ?>
									...
									<div class="row mb-3 d-flex align-items-center tarefa">
										...
										<div class="col-sm-3 mt-2 d-flex justify-content-between">
											...
											<i class="fas fa-edit fa-lg text-info" onclick="editarTarefa(<?= $tarefa['id'] ?>, '<?= $tarefa['tarefa'] ?>', 'ref=index&')" style="cursor: pointer"></i>

											<i class="fas fa-check-square fa-lg text-success" onclick="marcarTarefaConcluido(<?= $tarefa['id'] ?>, 'ref=index&')" style="cursor: pointer"></i>
										</div>
									</div>
